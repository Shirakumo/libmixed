...
#include "encoding.h"
  ...
  // produced samples to its output buffers, if any. If this
  // number ever reaches zero, the segment is considered to be
  // done, and no further samples can be expected to be produced
  // until the segment is restarted.
  //
